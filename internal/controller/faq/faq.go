...
func NewController(svc service.FAQService) *Controller {
	return &Controller{svc: svc}
}

func (c *Controller) Create(ctx *gin.Context) {
	var req faqv1.CreateReq
...
func (c *Controller) Delete(ctx *gin.Context) {
	...
	ctx.JSON(http.StatusOK, faqv1.DeleteRes{Status: "ok"})
}
...
func writeErr(ctx *gin.Context, err error) {
	switch {
	case errors.Is(err, service.ErrFAQNotFound):
