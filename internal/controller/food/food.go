...
func NewController(svc service.FoodService) *Controller {
	return &Controller{svc: svc}
}

func (c *Controller) Create(ctx *gin.Context) {
	var req foodv1.CreateReq
...
func (c *Controller) Delete(ctx *gin.Context) {
	...
	ctx.JSON(http.StatusOK, foodv1.DeleteRes{Status: "ok"})
}
