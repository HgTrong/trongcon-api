...
type MealPlan struct {
	...
	Items       []MealPlanItem `json:"items,omitempty" gorm:"foreignKey:MealPlanID;constraint:OnUpdate:CASCADE,OnDelete:CASCADE"`
}
...
type MealPlanItem struct {
	...
	Quantity     float64 `json:"quantity" gorm:"type:numeric(10,2);not null;default:1"` // serving multiplier
